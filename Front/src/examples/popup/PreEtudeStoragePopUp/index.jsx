...
const preEtudeStorageModal = ({ preEtudeId, fetchFiles, onSave, onClose }) => {
  ...
  useEffect(() => {
    const fetchFilesForPreEtude = async () => {
      if (!preEtudeId) {
    ...
    fetchFilesForPreEtude();
  }, [preEtudeId, fetchFiles]);
  ...
  const handleDownloadFile = async file => {
    try {
      ...
      const result = await preEtudeStorageService.downlaodPreEtudeFile(filePath);
