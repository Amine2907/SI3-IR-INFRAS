...
const PreEtudeStorageModal = ({ preEtude, onSave, onClose }) => {
  ...
  useEffect(() => {
    const fetchFiles = async () => {
      try {
        // const response = await preEtudeStorageService.generatepreEtudeSignedUrl();
        if (response.success) {
          setFiles(
          ...
          console.error('Error fetching preEtude files:', response.error);
        }
      } catch (error) {
        console.error('Error fetching preEtude files:', error);
      }
    };
    fetchFiles();
  }, []);
  ...
  const handleSubmit = async () => {
    ...
    // Call the uploadpreEtude function
    // const result = await preEtudeStorageService.uploadpreEtude(file);
    if (result.success) {
...
PreEtudeStorageModal.propTypes = {
  preEtude: PropTypes.object,
  onSave: PropTypes.func.isRequired,
  onClose: PropTypes.func.isRequired,
};
export default PreEtudeStorageModal;
