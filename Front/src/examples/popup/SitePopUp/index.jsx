      ...
      <div className={styles.modalContent}>
        ...
        <div className={styles.formGrid}>
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>EB*</label>
            <MDInput
              name="EB"
              value={formData.EB || ''}
          ...
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>G2R*</label>
            <MDInput
              name="G2R"
              value={formData.G2R || ''}
              onChange={handleChange}
          ...
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>Nom</label>
            <MDInput
              name="nom"
              value={formData.nom || ''}
              onChange={handleChange}
          ...
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>
              Priorite
            </label>
            <FormControl
              fullWidth
          ...
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>Lot</label>
            <MDInput
              name="lot"
              value={formData.lot || ''}
              onChange={handleChange}
          ...
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>Ville</label>
            <MDInput
              name="Ville"
          ...
          <div style={{ marginBottom: '1px' }}>
            <label style={{ display: 'block', marginBottom: '0px', fontSize: '14px' }}>Zone</label>
            <MDInput
              name="zone"
              value={formData.zone || ''}
              onChange={handleChange}
