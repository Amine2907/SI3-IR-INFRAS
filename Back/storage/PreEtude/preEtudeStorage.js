...
const downloadPdf = async (filePath) => {
  try {
    ...
    // Ensure that the file path has only one 'pre-etude-pdf/' prefix
    const fixedFilePath = filePath.startsWith('pre-etude-pdf/') ? filePath : `pre-etude-pdf/${filePath}`;
...
export default preEtudeStorage;
